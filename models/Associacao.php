...
class Associacao extends \yii\db\ActiveRecord
{
    ...
    {
        return Associacao::findBySql('SELECT id, nome FROM cidade ORDER BY nome ASC')->all();
    }

    public function getUsuarios()
    {
        return Associacao::findBySql('SELECT id, nome, email from usuario ORDER BY nome ASC')->all();
    }
